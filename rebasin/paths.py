...
class ParallelPaths:
    ...
    @property
    def input_permutation(self) -> None:
        """The permutation of the input to the first module."""
    ...
    @property
    def output_permutation(self) -> None:
        """The permutation of the output of the last module."""
        raise NotImplementedError
    ...
    def connect_to_previous_path(self) -> None:
        """
        Connect the input of the first module of this path to the output of
        the last module of the previous path.
        """
        raise NotImplementedError
